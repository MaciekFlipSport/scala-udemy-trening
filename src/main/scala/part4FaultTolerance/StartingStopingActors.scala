...
import part4FaultTolerance.StartingStopingActors.Parent.StartChild

object StartingStopingActors extends App{

  val system = ActorSystem("StopingActorsdemo")
...
////  for (_ <- 1 to 50) child ! "Are you ok?"
//
...
//  looseActor ! "Hello, loosee actor"
//  looseActor ! PoisonPill
//  looseActor ! "loose actor, are you alive?"
//
//  val abuplyTerminatedActor = system.actorOf(Props[Child])
//  abuplyTerminatedActor ! "you are about to be terminated"
//  abuplyTerminatedActor ! Kill
//  abuplyTerminatedActor ! "You have been terminated"
